...
def create_gantt_chart(
    ...
    for i, phase in enumerate(phases):
        ...
        draw_label(ax, (start + end) / 2, i * dy + dy, dz, label, dz, max_phases)
    ...
    for dep_num, dependency in enumerate(dependencies):
        ...
        draw_dependency(ax, start_x, start_y, end_x, end_y, dep_num * 0.1, dz / 10)
...
# Commenting out the main call to prevent automatic execution in this environment
